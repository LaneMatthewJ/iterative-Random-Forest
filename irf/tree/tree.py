...
CRITERIA_REG = {
    ...
    "mse":             _criterion.MSE,           # legacy alias
    "friedman_mse":    _criterion.FriedmanMSE,
    "absolute_error":  _criterion.MAE,
    # "poisson":         _criterion.Poisson,
    "causal":          _criterion.ATE,
...
class WeightedDecisionTreeClassifier(RegressorMixin, BaseDecisionTree):
    def __init__(
        self,
        *,
        ...
        # simply store every arg as an attribute
    ...
    #     return self.tree_.predict(X)            # tree_ comes from builder.build()
    ...
    def fit(self, X, y, 
        ...
        self.max_features_ = int(max_features)
...
class WeightedDecisionTreeRegressor(RegressorMixin, BaseDecisionTree):
    def __init__(
        self,
        *,
        criterion="squared_error",
